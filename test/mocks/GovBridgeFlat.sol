...
//
// Provenance: `forge flatten` of the gov-bridge sources
//   - sky-ecosystem/sky-oapp-oft@0baba10c77a5cdfcef8fe9611e38d4306ab827a7
//       (contracts/GovernanceOAppSender.sol, contracts/GovernanceOAppReceiver.sol)
//   - sky-ecosystem/lz-governance-relay@d3e3df4db417f196fdd56123e7dbb462d04f32ef
//       (src/L1GovernanceRelay.sol)
// plus their OpenZeppelin / LayerZero-v2 OApp dependencies. Compiled under this repo's
// settings, so behavior is faithful but the bytecode is not bit-identical to the
// deployed/audited artifacts. Regenerate via `forge flatten`; do not hand-edit.
//
...
// src/interfaces/IGovernanceOAppReceiver.sol
...
// src/GovernanceOAppReceiver.sol
...
// src/interfaces/IGovernanceOAppSender.sol
